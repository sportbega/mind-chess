...
FILES="index.html chess-0.10.3.js jspdf.umd.min.js stockfish-18-lite-single.js stockfish-18-lite-single.wasm supabase-config.js stt-worker.js puzzles.json openings.json"
